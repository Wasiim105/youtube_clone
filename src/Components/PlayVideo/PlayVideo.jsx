...
const PlayVideo = () => {
  ...
  const fetchOtherData = async () => {
    ...
    const comment_url = `https://www.googleapis.com/youtube/v3/commentThreads?part=snippet%2Creplies&maxResults=45&videoId=${videoId}&key=${API_KEY}`;
  ...
  return (
    <div className='play-video'>
      ...
      <iframe src={`https://www.youtube.com/embed/${videoId}?autoplay=1`} frameBorder="0" allow="accelerometer;
        ...
        <div className="vid-description">
          ...
          <hr />
          <h4>{apiData?value_converter(apiData.statistics.commentCount):344} Comments</h4>
